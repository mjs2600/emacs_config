...
This is a list of all of the packages that I use.
   #+begin_src emacs-lisp
     (setq my-packages '(pallet starter-kit starter-kit-bindings starter-kit-eshell
                                 starter-kit-js starter-kit-ruby starter-kit-lisp
                                 auto-complete ac-nrepl cyberpunk-theme pretty-mode
                                 rvm rsense paredit geiser projectile helm
                                 helm-projectile yasnippet yasnippet-bundle 
                                 coffee-mode mmm-mode))
   #+end_src
